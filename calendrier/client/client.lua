...
print("^0[^1Téléchargement^0] ^7:^0 ^5https://discord.gg/kjHbNDE469^7")
print("^0[^1Preview^0] ^7:^0 ^5https://www.youtube.com/watch?v=nr5p-efg6OY&t=360s^7")
print("^0[^1Discord Yamsoo^0] ^7:^0 ^5https://discord.gg/eSzkfnGNdy^7")
print("^0======================================================================^7")
